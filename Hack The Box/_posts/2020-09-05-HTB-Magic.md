...
solid, now we have compromised theseus account. lets run linux enumeration scripts like [LinEnum.sh](https://raw.githubusercontent.com/rebootuser/LinEnum/master/LinEnum.sh)
